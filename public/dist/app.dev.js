  ...
  return regeneratorRuntime.async(function getCryptoData$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(axios("https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=eur&days=1&interval=daily") // respones handlers and function callers
          .then(function (res) {
            ...
            cleanedDecimals = setDecimals(cleanDataObj);
            console.log(cleanedDecimals);
            convertToDates = setDates(cleanDataObj);
            console.log(cleanedDecimals); // {0: "Alex", 1: "Bob", 2: "Johny", 3: "Atta"}
            // // cryptoCurrencies wordt overschreven door de nieuwe array die is gemaakt in de functie getlastupdated
            // // 1.
            // cryptoData = setDecimals(cryptoData);
            //  2.
